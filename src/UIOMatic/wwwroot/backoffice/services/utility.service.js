...
(function () {
    ...
    function utilityService() {
        ...
        var service = {
            ...
            useLegacyPaginationControl: function() {
                return this.compareCurrentUmbracoVersion("7.4", { zeroExtend: true }) < 0;
            }
        };
    ...
    angular.module('umbraco.services').factory('uioMaticUtilityService', utilityService);
