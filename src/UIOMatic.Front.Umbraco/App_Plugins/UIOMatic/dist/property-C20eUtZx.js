...
const v = (r) => new b(typeof r == "string" ? r : r + "", void 0, g), w = (r, t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: P, defineProperty: U, getOwnPropertyDescriptor: C, getOwnPropertyNames: O, getOwnPropertySymbols: A, getPrototypeOf: M } = Object, c = globalThis, m = c.trustedTypes, R = m ? m.emptyScript : "", f = c.reactiveElementPolyfillSupport, d = (r, t) => r, u = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? R : null;
      break;
  ...
  return e;
} }, $ = (r, t) => !P(r, t), S = { attribute: !0, type: String, converter: u, reflect: !1, useDefault: !1, hasChanged: $ };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const T = { attribute: !0, type: String, converter: u, reflect: !1, hasChanged: $ }, j = (r = T, t, e) => {
