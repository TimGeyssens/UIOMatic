    ...
    public class DefaultUIOMaticRepository : IUIOMaticRepository
    {
        ...
        public virtual IEnumerable<object> GetAll(string sortColumn = "", string sortOrder = "")
        {
            ...
            using (IScope scope = _scopeProvider.CreateScope(autoComplete: true))
            {
                ...
                var a1 = new QueryEventArgs(_typeInfo.Type, _typeInfo.TableName, query.SQL, sortColumn, sortOrder, "", null);
                _uioMaticObjectService.OnBuildingQuery(a1);
                query = new Sql(a1.Query);
                ...
                var a2 = new QueryEventArgs(_typeInfo.Type, _typeInfo.TableName, query.SQL, sortColumn, sortOrder, "", null);
                _uioMaticObjectService.OnBuiltQuery(a2);
                query = new Sql(a2.Query);
            ...
            string sortOrder = "")
        {
            ...
            using (IScope scope = _scopeProvider.CreateScope(autoComplete: true))
            {
                ...
                var a1 = new QueryEventArgs(_typeInfo.Type, _typeInfo.TableName, query.SQL, sortColumn, sortOrder, searchTerm, filters);
                _uioMaticObjectService.OnBuildingQuery(a1);
                query = new Sql(a1.Query);
                ...
                var a2 = new QueryEventArgs(_typeInfo.Type, _typeInfo.TableName, query.SQL, sortColumn, sortOrder, searchTerm, filters);
                _uioMaticObjectService.OnBuiltQuery(a2);
                query = new Sql(a2.Query);
