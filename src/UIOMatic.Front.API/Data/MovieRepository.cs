...
namespace UIOMatic.Front.API.Data
{
    public class MovieRepository : IUIOMaticRepository
    {
        ...
        public const string ApiEndPoint = "https://crudcrud.com/api/c388b6d1ebe84934816797e0e92118a7/movies/";
        ...
        public IEnumerable<object> GetAll(string sortColumn = null, string sortOrder = null)
        {
